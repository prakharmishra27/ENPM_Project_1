...
if __name__=="__main__":
    ...
    pub_right = rospy.Publisher('/front_right_steering_controller/command', Float64, queue_size=10) 
    pub_left = rospy.Publisher('/front_left_steering_controller/command', Float64, queue_size=10)
    pub_move = rospy.Publisher('/rear_wheels_controller/command', Float64, queue_size=10)
